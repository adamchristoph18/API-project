    ...
    return (
        ...
        >
            ...
            <div className="form-info">
                ...
                <div>
                    <p><span className="describe-title">Create a title for your spot</span>
                        <br/>
                        <span className="describe-tips">Catch guests' attention with a spot title that highlights
